...
var _longMonthName = function longMonthName() {
  var monthNum = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  return new Date(1, monthNum, 1).toLocaleString("default", {
    month: "long"
  });
...
window.initApp = function (hugoFoods) {
  return {
    ...
    longMonthName: function longMonthName(monthNum) {
      return _longMonthName(monthNum);
    }
  };
};
...
__webpack_require__(/*! X:\Sites\inseason\site\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! X:\Sites\inseason\site\src\scss\app.scss */"./src/scss/app.scss");
