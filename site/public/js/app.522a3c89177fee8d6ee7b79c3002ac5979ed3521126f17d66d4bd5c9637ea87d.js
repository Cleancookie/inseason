...
var _shortMonthName = function shortMonthName() {
  var monthNum = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
window.initApp = function (hugoFoods) {
  return {
    ...
    countVisible: function countVisible(items) {
      var _this = this;

      return items.reduce(function (carry, item) {
        return carry + (item.best[_shortMonthName(_this.month)] ? 1 : 0);
      }, 0);
    },
    shortMonthName: function shortMonthName(monthNum) {
      return _shortMonthName(monthNum);
    }
  };
};
...
__webpack_require__(/*! /Users/evoluted/projects/inseason/site/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /Users/evoluted/projects/inseason/site/src/scss/app.scss */"./src/scss/app.scss");
